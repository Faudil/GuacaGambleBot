...
var all = []Item{
	...
	{ID: "rusty_magnet", Name: "Rusty Magnet", Emoji: "🧲", Price: 30, Description: "Pulls scrap ore from the ground. In the mine, farm or Undercroft it can unearth buried hoards.", EffectType: "consumable", Droppable: false, Category: Tools},
	{ID: "magnet", Name: "Magnet", Emoji: "🧲", Price: 100, Description: "Pulls precious ore from the ground. In the mine, farm or Undercroft it can unearth buried hoards.", EffectType: "consumable", Droppable: false, Category: Tools},
	{ID: "electric_magnet", Name: "Electric Magnet", Emoji: "🧲", Price: 600, Description: "Pulls valuable ore from deep underground. In the mine, farm or Undercroft it can unearth rich hoards.", EffectType: "consumable", Droppable: false, Category: Tools},
