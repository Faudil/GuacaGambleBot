...
var ResearchDefs = map[string]*ResearchDef{
	...
	"advanced_botany": {
		...
		TimeHours: 16, CostMoney: 8000, CostItems: map[string]int{"rotten_plant": 20, "emerald": 10},
	...
	// --- Fossil Reanimation Research (genetics lab, one-time unlocks) ---
	"reanimate_common": {
		ID: "reanimate_common", Name: "Reanimation: Common Fossils", Description: "Learn to reanimate simple prehistoric life from common fossils.",
		TimeHours: 6, CostMoney: 2500, CostItems: map[string]int{"bone_dust": 15, "damaged_fossil": 3, "coal": 10},
		RequiredFurniture: "genetics_lab",
		BonusDesc:         "Unlocks: Reanimating Common Fossils",
	},
	"reanimate_rare": {
		ID: "reanimate_rare", Name: "Reanimation: Rare Fossils", Description: "Perfect the technique to revive rarer prehistoric creatures.",
		TimeHours: 12, CostMoney: 5000, CostItems: map[string]int{"bone_dust": 25, "common_fossil": 3, "iron_ore": 10},
		RequiredFurniture: "genetics_lab",
		BonusDesc:         "Unlocks: Reanimating Rare Fossils",
	},
	"reanimate_epic": {
		ID: "reanimate_epic", Name: "Reanimation: Epic Fossils", Description: "Advanced genetic engineering for epic prehistoric life.",
		TimeHours: 18, CostMoney: 10000, CostItems: map[string]int{"bone_dust": 40, "rare_fossil": 3, "platinum": 10},
		RequiredFurniture: "genetics_lab",
		BonusDesc:         "Unlocks: Reanimating Epic Fossils",
	},
	"reanimate_legendary": {
	...
	"equip_common": {
		...
		TimeHours: 2, CostMoney: 1000, CostItems: map[string]int{"coal": 10, "pebble": 6},
	...
	"equip_uncommon": {
		...
		TimeHours: 4, CostMoney: 3000, CostItems: map[string]int{"iron_ore": 20},
		RequiredFurniture: "forge",
	...
	"equip_rare": {
		...
		TimeHours: 8, CostMoney: 8000, CostItems: map[string]int{"silver_ore": 10, "emerald": 6},
		RequiredFurniture: "forge",
	...
	"equip_epic": {
		...
		TimeHours: 16, CostMoney: 16000, CostItems: map[string]int{"platinum": 10, "rough_diamond": 6},
	...
	"set_dragon_slayer": {
		...
		TimeHours: 12, CostMoney: 10000, CostItems: map[string]int{"rough_diamond": 6, "gold_nugget": 10},
		RequiredFurniture: "forge",
	...
	"set_shadow_stalker": {
		...
		TimeHours: 12, CostMoney: 10000, CostItems: map[string]int{"platinum": 10, "emerald": 6},
		RequiredFurniture: "forge",
	...
	"set_arcane_weaver": {
		...
		TimeHours: 12, CostMoney: 10000, CostItems: map[string]int{"platinum": 10, "rough_diamond": 6, "emerald": 4},
		RequiredFurniture: "arcane_forge",
