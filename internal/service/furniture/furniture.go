...
var FurnitureDefs = map[string]*FurnitureDef{
	...
	"enchanting_table": {
		...
		SlotType:        "table",
		Slots:           2,
		CostItems:       map[string]int{"silver_ore": 15, "pufferfish": 9},
	...
	"magnetic_coil": {
		...
		SlotType:        "table",
		Slots:           1,
		CostItems:       map[string]int{"copper_ore": 30, "iron_ore": 15},
	...
	"bed": {
		...
		SlotType:        "floor",
		Slots:           2,
		CostItems:       map[string]int{"stick": 30, "wheat": 15},
	...
	"genetics_lab": {
		...
		SlotType:        "floor",
		Slots:           3,
		CostItems:       map[string]int{"pure_dna": 15, "bone_dust": 60, "emerald": 6},
