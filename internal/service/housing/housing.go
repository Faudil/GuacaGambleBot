...
var Houses = map[string]*HouseType{
	"cardboard_box": {
		...
		InventoryBonus: 5, PetSlotsBonus: 1, BankCapacity: 500, Color: 0xB9936C,
		Buffs: []string{"+5 Inventory Slots", "+1 Pet Slot", "$500 Bank Cap"},
	},
	"wooden_shack": {
		ID: "wooden_shack", Price: 5000, MaxLevel: 3, IncomePerHour: 50,
		InventoryBonus: 20, PetSlotsBonus: 2, BankCapacity: 10000, CraftingDiscount: 0.05, Color: 0xA1887F,
	...
	"brick_house": {
		...
		InventoryBonus: 50, PetSlotsBonus: 5, BankCapacity: 2000, CraftingDiscount: 0.10, Color: 0xD32F2F,
	...
	"mansion": {
		...
		InventoryBonus: 100, PetSlotsBonus: 10, BankCapacity: 5000, CraftingDiscount: 0.20, Color: 0x1E88E5,
	...
	"gilded_palace": {
		...
		InventoryBonus: 250, PetSlotsBonus: 25, BankCapacity: 1000000, CraftingDiscount: 0.30, Color: 0xFFB300,
