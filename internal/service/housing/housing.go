...
var Houses = map[string]*HouseType{
	"cardboard_box": {
		ID: "cardboard_box", Price: 50, MaxLevel: 1, IncomePerHour: 5,
	...
	"wooden_shack": {
		ID: "wooden_shack", Price: 500, MaxLevel: 3, IncomePerHour: 50,
	...
	"brick_house": {
		ID: "brick_house", Price: 5000, MaxLevel: 5, IncomePerHour: 250,
	...
	"mansion": {
		ID: "mansion", Price: 25000, MaxLevel: 10, IncomePerHour: 1000,
