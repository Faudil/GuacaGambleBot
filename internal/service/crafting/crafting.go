...
var Recipes = map[string]Recipe{
	...
	"rusty_magnet":        {Result: "rusty_magnet", Ingredients: map[string]int{"iron_ore": 2, "pebble": 4}, LevelRequired: 3, XP: 20, RequiredResearch: "tool_crafting"},
	...
	"magnet":              {Result: "magnet", Ingredients: map[string]int{"iron_ore": 5, "copper_ore": 2, "silver_ore": 1}, LevelRequired: 5, XP: 40, RequiredResearch: "magnetism"},
	...
	"electric_magnet":     {Result: "electric_magnet", Ingredients: map[string]int{"platinum": 5, "copper_ore": 10, "gold_nugget": 1}, LevelRequired: 7, XP: 60, RequiredResearch: "magnetism"},
