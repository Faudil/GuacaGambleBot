...
var Recipes = map[string]Recipe{
	...
	"forget_potion":       {Result: "forget_potion", Ingredients: map[string]int{"rotten_plant": 2, "pufferfish": 1}, LevelRequired: 1, XP: 20, RequiredResearch: "scroll_magic"},
	"bow":                 {Result: "bow", Ingredients: map[string]int{"oat": 2, "pebble": 2}, LevelRequired: 1, XP: 25, RequiredResearch: "tool_crafting"},
	"rusty_magnet":        {Result: "rusty_magnet", Ingredients: map[string]int{"iron_ore": 2, "pebble": 4}, LevelRequired: 1, XP: 20, RequiredResearch: "tool_crafting"},
	"hook":                {Result: "hook", Ingredients: map[string]int{"iron_ore": 1, "silver_ore": 1}, LevelRequired: 1, XP: 25, RequiredResearch: "tool_crafting"},
	...
	"magnet":              {Result: "magnet", Ingredients: map[string]int{"iron_ore": 5, "copper_ore": 2, "silver_ore": 1}, LevelRequired: 1, XP: 40, RequiredResearch: "magnetism"},
	"rigged_coin":         {Result: "rigged_coin", Ingredients: map[string]int{"gold_nugget": 1, "pebble": 2, "coal": 1}, LevelRequired: 1, XP: 45, RequiredResearch: "game_theory"},
	...
	"electric_magnet":     {Result: "electric_magnet", Ingredients: map[string]int{"platinum": 5, "copper_ore": 10, "gold_nugget": 1}, LevelRequired: 1, XP: 60, RequiredResearch: "magnetism"},
	...
	"stonebread":     {Result: "stonebread", Ingredients: map[string]int{"pebble": 3, "potato": 2}, LevelRequired: 1, XP: 20},
	"zephyr_berries": {Result: "zephyr_berries", Ingredients: map[string]int{"trout": 3, "carrot": 2}, LevelRequired: 1, XP: 20},
	"hunters_soup":   {Result: "hunters_soup", Ingredients: map[string]int{"carp": 3, "tomato": 2}, LevelRequired: 1, XP: 25},
	"lucky_roast":    {Result: "lucky_roast", Ingredients: map[string]int{"carp": 3, "pumpkin": 2}, LevelRequired: 1, XP: 25},
	"thunder_steak":  {Result: "thunder_steak", Ingredients: map[string]int{"salmon": 3, "potato": 2}, LevelRequired: 1, XP: 25},
	"heart_stew":     {Result: "heart_stew", Ingredients: map[string]int{"salmon": 2, "oat": 3}, LevelRequired: 1, XP: 20},
	"dragon_chili":   {Result: "dragon_chili", Ingredients: map[string]int{"trout": 3, "corn": 2}, LevelRequired: 1, XP: 25},
	"iron_loaf":      {Result: "iron_loaf", Ingredients: map[string]int{"coal": 2, "oat": 3}, LevelRequired: 1, XP: 20},
	"storm_porridge": {Result: "storm_porridge", Ingredients: map[string]int{"sardine": 3, "coffee_bean": 2}, LevelRequired: 1, XP: 25},
	"falcon_pie":     {Result: "falcon_pie", Ingredients: map[string]int{"wheat": 3, "pumpkin": 2}, LevelRequired: 1, XP: 25},
	"clover_salad":   {Result: "clover_salad", Ingredients: map[string]int{"corn": 3, "cocoa_bean": 1}, LevelRequired: 1, XP: 25},
	"volcano_ribs":   {Result: "volcano_ribs", Ingredients: map[string]int{"coal": 3, "salmon": 2}, LevelRequired: 1, XP: 25},
	"giant_noodles":  {Result: "giant_noodles", Ingredients: map[string]int{"wheat": 3, "trout": 2}, LevelRequired: 1, XP: 20},
	...
	"craft_leather_armor": {Result: "leather_armor", Ingredients: map[string]int{"iron_ore": 3, "coal": 2}, LevelRequired: 1, XP: 20, RequiredResearch: "equip_common", IsEquipment: true},
