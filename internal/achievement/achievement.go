...
func localPetRarity(petType string) string {
	m := map[string]string{
		...
		"Trilobite": "common", "Ammonite": "common", "Anomalocaris": "common",
		"Orthoceras": "common", "Méganeura": "common",
		"Chien": "rare", "Chat": "rare", "Cheval": "rare", "Renard": "rare",
		"Singe": "rare", "Ours": "rare", "Gorille": "rare", "Scorpion": "rare",
		"Ours polaire": "rare",
		"Archéoptéryx": "rare", "Ptéranodon": "rare", "Dimétrodon": "rare",
		"Smilodon": "rare", "Mégalocéros": "rare", "Doedicurus": "rare",
		...
		"Mosasaurus": "epic", "Titanoboa": "epic", "Phorusrhacos": "epic",
		"Rhinocéros laineux": "epic", "Entelodon": "epic",
